...
const Footer = () => {
    return (
        <footer className="footer footer-center lg:footer-horizontal bg-neutral text-neutral-content px-8 py-6 border-t border-base-300">
            ...
            <ul className="flex flex-wrap justify-center gap-4 text-sm">
                ...
                <li>
                  <Link to="/cancellation" className="hover:text-primary">
                    Cancellation
                  </Link>
                </li>
                <li>
